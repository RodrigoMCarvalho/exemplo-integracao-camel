...
public class LivroInit implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        Livro livro1 = Livro.builder().titulo("Sandman").autorId(1L).build();
        Livro livro2 = Livro.builder().titulo("Cavaleiro das Trevas").autorId(2L).build();
        Livro livro3 = Livro.builder().titulo("Queda de Murdock").autorId(2L).build();
